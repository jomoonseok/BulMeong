...
CREATE TABLE USERS (
   ...
   AGE   SMALLINT      NULL,
   PROFILE_IMAGE   VARCHAR(255)      NULL DEFAULT '/images/basic_profileImage.png',
...
CREATE TABLE USERS_ACCESS (
   ...
   CONSTRAINT FK_ACCESS_USERS FOREIGN KEY(ID) REFERENCES USERS (ID)
);
...
CREATE TABLE CAMP_CART (
   ...
   CONSTRAINT FK_CAMPCART_CAMP FOREIGN KEY(CAMP_NO) REFERENCES CAMP (CAMP_NO) 
);
...
VALUES
   ('admin', '관리자', 'CD942870AC6B16 82EF9838AE045ACBF5C8FF2 58AB8155CA968C3B06D3FC4B7', '관리자', '01012345678', 'NO', 2000, 0101, NULL, NULL, NULL, NULL, NULL, DATE_FORMAT(NOW(), '%y/%m/%d'), 0, NULL, NULL, NULL, 'admin@web.com', NULL, DATE_FORMAT(NOW(), '%y/%m/%d'), DATE_FORMAT(NOW(), '%y/%m/%d'));

-- 휴면
INSERT INTO USERS
   (ID, NICKNAME, PW, NAME, MOBILE, GENDER, BIRTH_YEAR, BIRTH_DAY, POSTCODE, ROAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, EXTRA_ADDRESS, JOIN_DATE, AGREE_CODE, SNS_TYPE, SESSION_ID, SESSION_LIMIT_DATE, EMAIL, AGE, PW_MODIFY_DATE, INFO_MODIFY_DATE)
VALUES
   ('user99', '휴면유저', 'ADB2B265835955B6637E50945D7A92AB7BD916 FA2E3705D 384B5EB9D177D40', '휴면', '01099999999', 'NO', 1999, 0909, NULL, NULL, NULL, NULL, NULL, DATE_FORMAT('2021-12-01', '%y/%m/%d'), 0, NULL, NULL, NULL, 'sleep@web.com', NULL, DATE_FORMAT('2021-12-01', '%y/%m/%d'), DATE_FORMAT('2021-12-01', '%y/%m/%d'));
...
INSERT INTO USERS
   (ID, NICKNAME, PW, NAME, MOBILE, GENDER, BIRTH_YEAR, BIRTH_DAY, POSTCODE, ROAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, EXTRA_ADDRESS, JOIN_DATE, AGREE_CODE, SNS_TYPE, SESSION_ID, SESSION_LIMIT_DATE, EMAIL, AGE, PW_MODIFY_DATE, INFO_MODIFY_DATE)
VALUES
   ('user01', '의적', 'ADB2B265835955B6637E50945D7A92AB7BD916 FA2E3705D 384B5EB9D177D40', '홍길동', '01011111111', 'NO', 1934, 0806, NULL, NULL, NULL, NULL, NULL, DATE_FORMAT(NOW(), '%y/%m/%d'), 0, NULL, NULL, NULL, 'moo-ni-moon@naver.com', NULL, DATE_FORMAT(NOW(), '%y/%m/%d'), DATE_FORMAT(NOW(), '%y/%m/%d'));
...
-- VALUES
--     (1, 0, '텐트1-글램핑', 2, NULL, 50000, NULL, '/image/tent/glamping.webp');
--     
-- INSERT INTO CAMP_TENT
--     (CAMP_NO, TENT_CATEGORY, TENT_NAME, TENT_MAX_COUNT, TENT_RESERVE_DAY, TENT_SUM, TENT_STATE, TENT_IMAGE)
-- VALUES
--     (1, 1, '텐트1-카라반', 5, NULL, 100000, NULL, '/image/tent/caraban.webp');

-- INSERT INTO CAMP_TENT
--     (CAMP_NO, TENT_CATEGORY, TENT_NAME, TENT_MAX_COUNT, TENT_RESERVE_DAY, TENT_SUM, TENT_STATE, TENT_IMAGE)
-- VALUES
--     (1, 2, '텐트1-일반야영장', 5, NULL, 20000, NULL, '/image/tent/general.webp');

-- INSERT INTO CAMP_TENT
--     (CAMP_NO, TENT_CATEGORY, TENT_NAME, TENT_MAX_COUNT, TENT_RESERVE_DAY, TENT_SUM, TENT_STATE, TENT_IMAGE)
-- VALUES
--     (1, 3, '텐트1-자동차야영장', 4, NULL, 30000, NULL, '/image/tent/carcamping.webp');

-- INSERT INTO CAMP_TENT
--     (CAMP_NO, TENT_CATEGORY, TENT_NAME, TENT_MAX_COUNT, TENT_RESERVE_DAY, TENT_SUM, TENT_STATE, TENT_IMAGE)
-- VALUES
--     (2, 0, '텐트2-글램핑', 2, NULL, 50000, 0, '/image/tent/glamping.webp');
--     
-- INSERT INTO CAMP_TENT
--     (CAMP_NO, TENT_CATEGORY, TENT_NAME, TENT_MAX_COUNT, TENT_RESERVE_DAY, TENT_SUM, TENT_STATE, TENT_IMAGE)
-- VALUES
--     (2, 1, '텐트2-카라반', 5, NULL, 100000, 1, '/image/tent/caraban.webp');

-- INSERT INTO CAMP_TENT
--     (CAMP_NO, TENT_CATEGORY, TENT_NAME, TENT_MAX_COUNT, TENT_RESERVE_DAY, TENT_SUM, TENT_STATE, TENT_IMAGE)
-- VALUES
--     (2, 2, '텐트2-일반야영장', 5, NULL, 20000, 1, '/image/tent/general.webp');

-- INSERT INTO CAMP_TENT
--     (CAMP_NO, TENT_CATEGORY, TENT_NAME, TENT_MAX_COUNT, TENT_RESERVE_DAY, TENT_SUM, TENT_STATE, TENT_IMAGE)
-- VALUES
--     (2, 3, '텐트2-자동차야영장', 4, NULL, 30000, 1, '/image/tent/carcamping.webp');
