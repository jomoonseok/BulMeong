...
CREATE TABLE CAMP_CART (
   CAMP_CART_NO  INT      NOT NULL AUTO_INCREMENT,
   CAMP_NO  INT      NOT NULL,
   ID   VARCHAR(50)      NOT NULL,
   CONSTRAINT PK_CAMP_CART PRIMARY KEY(CAMP_CART_NO),
...
VALUES
   ('admin', '관리자', 'CD942870AC6B16 82EF9838AE045ACBF5C8FF2 58AB8155CA968C3B06D3FC4B7', '관리자', '01012345678', 'NO', NULL, NULL, NULL, NULL, NULL, NULL, NULL, DATE_FORMAT(NOW(), '%y/%m/%d'), 0, NULL, NULL, NULL, 'admin@web.com', NULL, DATE_FORMAT(NOW(), '%y/%m/%d'), DATE_FORMAT(NOW(), '%y/%m/%d'));
